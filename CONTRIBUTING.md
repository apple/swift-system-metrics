...
* Swift System Metrics commit hash
* Contextual information (e.g. what you were trying to achieve with Swift System Metrics)
...
```
Swift System Metrics commit hash: b17a8a9f0f814c01a56977680cb68d8a779c951f

Context:
While testing my application that uses with Swift System Metrics, I noticed that ...
...
2. Open a pull request at https://github.com/apple/swift-system-metrics and wait for code review by the maintainers.
